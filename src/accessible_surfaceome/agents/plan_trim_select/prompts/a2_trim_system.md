...
* **Pure surface-presence statements without tissue / state / compartment context.** "GENEX is at the plasma membrane" alone is A1; A2 needs the "where, in what cell type, under what condition" qualifier.
