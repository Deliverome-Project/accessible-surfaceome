...
6. **Do the gene name or known aliases hint at non-canonical biology?** Activation- or stress-state naming hints at cell-state induction. Names containing "latent" / "pro-protein" / "propeptide" / "pre-pro" hint at covalent / wash-resistant TM-partner tethering. Gene-symbol prefixes for canonical surface-protein families (receptor / channel / transporter / claudin / cadherin / integrin / tetraspanin / GPCR / SLC / ABC / Toll-like / Frizzled, etc.) are strong surface signals. Pause on such hints before defaulting to `no`.
