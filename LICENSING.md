...
| **SURFY** | Machine-learning surfaceome prediction (SURFY score) | No separate data licence is published for the prediction table; the article is [CC BY-NC-ND 4.0](https://www.pnas.org/doi/10.1073/pnas.1808790115) (PNAS) | Per-accession classifier output only, joined into the candidate universe. We do not redistribute the source table or the article. | Bausch-Fluck et al. 2018 (PNAS) |
...
| **SURFACE-Bind** | MaSIF-based binding-site patch scoring on the AlphaFold model | Data [CC BY 4.0](https://doi.org/10.5281/zenodo.15016859) (Zenodo deposit); code [BSD-3-Clause](https://github.com/hamedkhakzad/SURFACE-Bind/blob/main/LICENSE) | Derived patch scores | Balbi et al. 2026, PNAS (PMID 41604262) |
