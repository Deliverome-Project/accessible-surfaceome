...
preferentially captures by protein topology, across the 6,651-protein
...
6,651. Sonnet sits leftmost as the implicit reference; the 5 DBs
...
divides by the size of the universe (6,651 — every member of the
