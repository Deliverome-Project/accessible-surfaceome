...
/**
 * Where the canonical prompts live in the agent source tree. The
 * viewer reads them with ``fs`` at build time so the on-page text is
 * always the file the agents actually run with. Starting with just
 * ``triage``; the deep-dive (`surface_annotator/prompts/system.md`)
 * will be added once it stabilizes under the v0.5.0 schema.
 */
