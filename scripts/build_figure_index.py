...
FIGURE_ORDER: list[tuple[str, str]] = [
    ...
    ("Supp S3",   "curator_vs_agent_reason"),
    ("Supp S4",   "db_cutoff_tradeoff"),
    ...
    ("Supp S11",  "deep_dive_vs_sonnet_benchmark"),
...
def main() -> int:
    ...
    ).parse_args()  # no options; makes --help work instead of rewriting the index
