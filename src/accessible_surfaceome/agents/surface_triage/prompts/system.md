...
6. **Do the aliases / previous symbols hint at non-canonical biology?** Activation- or stress-state naming hints at cell-state induction. Names containing "latent" / "pro-protein" / "propeptide" hint at covalent / wash-resistant TM-partner tethering. Pause on such hints before defaulting to `no`.
